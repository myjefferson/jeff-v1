        ...
        <div className='container flex justify-center mx-auto pt-8 pb-8 text-white'>
            <div>
                ...
                <ul className='flex space-x-5 justify-center mb-16'>
                    <li><a href={profile.link_github} rel="noreferrer" target="_blank"><img src={github} alt="GitHub" className='rounded-full h-10'/></a></li>
                    <li><a href={profile.link_linkedin} rel="noreferrer" target="_blank"><img src={linkedin} alt="LinkedIn" className='rounded-full h-10'/></a></li>
                </ul>
